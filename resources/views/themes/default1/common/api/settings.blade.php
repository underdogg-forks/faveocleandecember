                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('api_enable') ? 'has-error' : '' }}">
                            ...
                            <div class="row">
                                <div class="col-xs-5">
                                    <input type="radio" name="api_enable" value="1" @if($systems->api_enable ==1)
                                    checked @endif>&nbsp;{{Lang::get('lang.enable')}}
                                    <!-- {!! Form::radio('api_enable','1',true) !!} {{Lang::get('lang.enable')}} -->
                                </div>
                                <div class="col-xs-5">
                                    <input type="radio" name="api_enable" value="0" @if($systems->api_enable == 0)
                                    checked @endif>&nbsp;{{Lang::get('lang.disable')}}
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('api_key_mandatory') ? 'has-error' : '' }}">
                            ...
                            <div class="row">
                                <div class="col-xs-5">
                                    <input type="radio" name="api_key_mandatory" value="1" @if($systems->api_key_mandatory
                                    == 1) checked @endif>&nbsp;{{Lang::get('lang.enable')}}
                                    <!-- {!! Form::radio('api_key_mandatory','1',true) !!} {{Lang::get('lang.enable')}} -->
                                </div>
                                <div class="col-xs-5">
                                    <input type="radio" name="api_key_mandatory" value="0" @if($systems->api_key_mandatory
                                    == 0) checked @endif>&nbsp;{{Lang::get('lang.disable')}}
                    ...
                    <div class="col-md-3">
                        <br />
                        <a class="btn btn-primary" id="generate"> <i class="fa fa-refresh"> </i> {!!
                            Lang::get('lang.generate_key') !!}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('ticket_detail') ? 'has-error' : '' }}">
                        ...
                        !!}
                        {!! Form::text('ticket_detail',$ticket_detail,['class' =>
        ...
        $('#generate').on('click', function (e) {
            $.ajax({
                ...
                beforeSend: function () {
                    $("#generate").empty();
                    var message =
                        "<i class='fa fa-refresh fa-spin'> </i>  <?php echo Lang::get('lang.generate_key'); ?>";
                ...
                success: function (response) {
                    ...
                    $("#messageBody").empty();
                    var message =
                        "<div class='alert alert-default' style='margin-bottom: -5px;'>Copy and paste in the api to set a different Api key</div> <br/><b>Api key</b> : " +
                        response;
                    ...
                    $("#generate").empty();
                    var message =
                        "<i class='fa fa-refresh'> </i>  <?php echo Lang::get('lang.generate_key'); ?>";
                    $('#generate').html(message);
                }
            })
            return false;
