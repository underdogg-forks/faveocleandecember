...
<body>
	<div id="page" class="hfeed site">My Perfect Frontend (Layout)
				...
				<div id="navbar" class="navbar-wrapper text-center">
					<nav class="navbar navbar-default site-navigation" role="navigation">
						<ul class="nav navbar-nav navbar-menu">
							...
							<li><a href="{{URL::route('form')}}">Submit A (perfect) Ticket</a></li>
							@endif
							@if(Auth::user())
									...
									<li>
										<div class="banner-wrapper user-menu text-center clearfix">
											...
											<div class="banner-content">
												{{-- <a href="{{url('kb/client-profile')}}" class="btn btn-custom btn-xs">Edit Profile</a> --}} <a href="{{url('auth/logout')}}"
			...
			<div class="container">
				...
				<div class="row">
					<div class="site-info col-md-6">
						<p class="text-muted">Copyright &copy; {!! date('Y') !!} <a href="{!! $company->website !!}">{!!
								$company->company_name !!}</a>. All rights reserved. Powered by <a href="http://www.faveohelpdesk.com/">Faveo</a></p>
					</div>
				</div>
		</footer><!-- #colophon -->
		<!-- jQuery 2.1.1 -->
