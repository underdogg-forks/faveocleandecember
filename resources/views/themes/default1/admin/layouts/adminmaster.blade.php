...
<body class="skin-yellow fixed">
    ...
    <div class="wrapper">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown notifications-menu" id="myDropdown">
                                ...
                                <ul class="dropdown-menu" style="width:500px">
                                    ...
                                    <li class="header">You have {!! $notifications->count() !!} notifications. <a class="pull-right"
                                            id="read-all" href="#">Mark all as read.</a></li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        @else
                                        <li style="list-style: none; margin-left: -30px;"><span>&nbsp<img src="{{$notification -> users -> profile_pic}}"
                                                    class="user-image" style="width:6%;height: 5%" alt="User Image" />
                                                <a href="{!! route('user.show', $notification->notification->model_id) !!}"
                                                    id="{{$notification -> notification_id}}" class='noti_User'>
                                                    {!! $notification->notification->type->message !!}
                                                </a></span>
                                        ...
                                        <li style="list-style: none;margin-left: -30px"><span>&nbsp<img src="{{$notification -> users -> profile_pic}}"
                                                    class="img-circle" style="width:6%;height: 5%" alt="User Image" />
                                                <a href="{!! route('ticket.thread', $notification->notification->model_id) !!}"
                                                    id='{{ $notification -> notification_id}}' class='noti_User'>
                                                    {!! $notification->notification->type->message !!} with id
                                                    "{!!$notification->notification->model->ticket_number!!}"
                        ...
                        <li class="dropdown">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><img src="{{asset("lb-faveo/flags/$src")}}"></img>
                        ...
                        <li>
                            ...
                            <a href="#" class="sidebar-toggle" data-toggle="control-sidebar" id="my-toggle-button" role="button">
                                <span class="sr-only">Toggle Control Sidebar</span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                            </a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview @yield('Staffs')">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li @yield('departments')><a href="{{ url('departments') }}"><i class="fa fa-sitemap"></i>{!!
                                    Lang::get('lang.departments') !!}</a></li>
                    ...
                    <li class="treeview @yield('Emails')">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li @yield('template')><a href="{{ url('template-sets') }}"><i class="fa fa-mail-forward"></i>{!!
                                    Lang::get('lang.templates') !!}</a></li>
                    ...
                    <li class="treeview @yield('Manage')">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li @yield('slaplans')><a href="{{url('slaplans')}}"><i class="fa fa-clock-o"></i>{!!
                            ...
                            <li @yield('priority')><a href="{{url('ticket/priority')}}"><i class="fa fa-asterisk"></i>{!!
                                    Lang::get('lang.ticketpriorities') !!}</a></li>
                        </ul>
                    </li>
                    <li class="treeview @yield('Tickets')">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li @yield('auto-response')><a href="{{url('getresponder')}}"><i class="fa fa-reply-all"></i>{!!
                                    Lang::get('lang.auto_response') !!}</a></li>
                            <li @yield('alert')><a href="{{url('getalert')}}"><i class="fa fa-bell"></i>{!!
                                    Lang::get('lang.alert_notices') !!}</a></li>
                            <li @yield('status')><a href="{{url('setting-status')}}"><i class="fa fa-plus-square-o"></i>{!!
                                    Lang::get('lang.status') !!}</a></li>
                            <li @yield('close-workflow')><a href="{{url('close-workflow')}}"><i class="fa fa-sitemap"></i>{!!
                                    Lang::get('lang.close-workflow') !!}</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview @yield('error-bugs')">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li @yield('debugging-option')><a href="{{ route('err.debug.settings') }}"><i class="fa fa-bug"></i>
                                    {!! Lang::get('lang.debug-options') !!}</a></li>
                        </ul>
                    </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="alert alert-info alert-dismissible">
                    ...
                    {{Lang::get('lang.dummy_data_installation_message')}} <a href="{{route('clean-database')}}">{{Lang::get('lang.click')}}</a>
        ...
        <div class="control-sidebar-bg">Control SideBar</div>
