...
?>
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <div class="tabs-content">
                        ...
                        <div class="tabs-pane @yield('manage-bar')" id="tabD">
                            <ul class="nav navbar-nav">
                                <li id="bar" @yield('help')><a href="{{url('helptopics')}}">Help Topic</a></li>
                                <li id="bar" @yield('slaplans')><a href="{{url('slaplans')}}">SLA Plans</a></li>
        ...
        <footer class="main-footer">
            ...
            <?php
                                ...
                                ?>
            <strong>Copyright &copy; {!! date('Y') !!} <a href="{!! $company->website !!}">{!! $company->company_name
                    !!}</a>.</strong> All rights reserved. Powered by <a href="http://www.faveohelpdesk.com/" target="blank">Faveo</a>
        </footer>
    </div><!-- ./wrapper -->
