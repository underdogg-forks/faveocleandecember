					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group {{ $errors->has('template_set_to_clone') ? 'has-error' : '' }}">
								...
								{!!Form::select('template_set_to_clone', [''=>'Select a
								Template','Templates'=>$templates->pluck('name','name')],1,['class' => 'form-control']) !!}
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group {{ $errors->has('language') ? 'has-error' : '' }}">
								...
								{!!Form::select('language', [''=>'Select a
								Language','languages'=>$languages->pluck('name','name')],null,['class' => 'form-control']) !!}
							</div>
						</div>
