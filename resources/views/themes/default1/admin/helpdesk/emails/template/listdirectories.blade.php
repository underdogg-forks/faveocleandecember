    ...
    <div class="box-body ">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td><a href="{{route('template.list',[$dir,$directory])}}">
                        <?php $parts = explode('.',$dir); $names  = $parts[0]; $name = str_replace('_', ' ', $names);$name1 = ucfirst($name); echo $name1?></a></td>
                <!-- template Status : if status==1 active -->
                <!-- Deleting Fields -->
                <?php $status = DB::table('email__settings')->first();  ?>
                <td><input type="radio" disabled="disabled" value="Active" <?php echo ($status->template ==
                    $dir)?'checked':'' ?> /></td>
                <td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                                    {!!
                                    link_to_route('templates.delete','Delete',[$dir,$directory],['id'=>'delete','class'=>'btn
                                    btn-danger btn-sm']) !!}
                                </div>
                            </div>
                        </div>
