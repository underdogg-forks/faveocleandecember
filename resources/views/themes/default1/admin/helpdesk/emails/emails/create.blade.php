    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-xs-4 form-group {!! $errors->has('department') ? 'has-error' : ''!!}" id="department_error">
                    ...
                    Default--','departments'=>$departments->pluck('name','id')->toArray()],null,['class' =>
                    'form-control select', 'id' => 'department' ]) !!}
                </div>
                <!-- Priority -->
                <div class="col-xs-4 form-group {!! $errors->has('priority') ? 'has-error' : ''!!}" id="priority_error">
                    ...
                    => 'form-control select', 'id' => 'priority']) !!}
                </div>
                <!-- Help topic -->
                <div class="col-xs-4 form-group {!! $errors->has('help_topic') ? 'has-error' : ''!!}" id="help_topic_error">
                    ...
                    Topics'=>$helps->pluck('topic','id')->toArray()],null,['class' => 'form-control select', 'id' =>
                    'help_topic']) !!}
                </div>
                <!-- status -->
        ...
        <div class="box-body">
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-2 form-group">
                        ...
                        <input type="checkbox" name="fetching_status" id="fetching_status">
            ...
            <div class="row">
                <div class="col-xs-2 form-group {!! $errors->has('fetching_protocol') ? 'has-error' : ''!!}" id="fetching_protocol_error">
                    ...
                    {!!Form::select('fetching_protocol',['imap' => 'IMAP', 'pop' => 'POP3'],null,['class' =>
                    'form-control select', 'id' => 'fetching_protocol']) !!}
                </div>
                ...
                <div class="col-xs-2 form-group {!! $errors->has('fetching_encryption') ? 'has-error' : ''!!}" id="fetching_encryption_error">
                    ...
                    {!!Form::select('fetching_encryption',[''=>'-----Select-----','ssl' => 'SSL', 'tls' => 'TLS',
                    'starttls' => 'STARTTLS'],null,['class' => 'form-control select', 'id' => 'fetching_encryption'])
                    !!}
                </div>
                <div class="col-xs-2 form-group {!! $errors->has('imap_authentication') ? 'has-error' : ''!!}" id="imap_authentication_error">
                    ...
                    {!!Form::select('imap_authentication',['normal' => 'Normal Password'],null,['class' =>
                    'form-control select', 'id' => 'imap_authentication']) !!}
                </div>
                <div class="col-xs-2 form-group">
                    <br>
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group {!! $errors->has('sending_protocol') ? 'has-error' : ''!!}" id="sending_protocol_error">
                    ...
                    {!!Form::select('sending_protocol',[''=>'Select','Drives'=>$services],null,['class' =>
                ...
                <div class="col-xs-2 form-group {!! $errors->has('sending_encryption') ? 'has-error' : ''!!}" id="sending_encryption_error">
                    ...
                    {!!Form::select('sending_encryption',[''=>'-----Select-----','ssl' => 'SSL', 'tls' => 'TLS',
                    'starttls' => 'STARTTLS'],null,['class' => 'form-control select']) !!}
                </div>
                <div class="col-xs-2 form-group {!! $errors->has('smtp_authentication') ? 'has-error' : ''!!}" id="smtp_authentication_error">
                    ...
                    {!!Form::select('smtp_authentication',['normal' => 'Normal Password'],null,['class' =>
                    'form-control select', 'id' => 'smtp_authentication']) !!}
                </div>
                <div class="col-xs-2 form-group">
                    <br>
        ...
        <div class="box-footer">
            {!! Form::button('<i id="spin" class="fa fa-spinner" style="display:none;"></i> <b>' .
                Lang::get("lang.create").'</b>' ,['class'=>'btn btn-primary', 'type' => 'submit'])!!}
        </div>
    </div>
</form>
