    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="form-group {!! $errors->has('name') ? 'has-error' : '' !!}">
                <label for="inputName" class="col-sm-2 control-label">{!! Lang::get('lang.name') !!} <span class="text-red">
                        *</span></label>
                <div class="col-sm-6">
                    {!! Form::text('name',null,['class' => 'form-control', 'placeholder' => Lang::get('lang.name'),
                    'id' => 'name']) !!}
                </div>
            </div>
            <div class="form-group {!! $errors->has('status') ? 'has-error' : '' !!}">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="radio" id="inputEmail1" name="status" value="0" checked>&nbsp;&nbsp;<label class="control-label"
            ...
            <div class="form-group {!! $errors->has('execution_order') ? 'has-error' : '' !!}">
                <div>
                    ...
                    <div class="col-sm-6">
                        {!! Form::input('number', 'execution_order',null,['class' => 'form-control', 'placeholder' =>
                        Lang::get('lang.execution_order'), 'id' => 'execution_order', 'min' => '0']) !!}
                    </div>
                </div>
            </div>
            <div class="form-group {!! $errors->has('target_channel') ? 'has-error' : '' !!}">
                <label class="col-sm-2 control-label">{!! Lang::get('lang.target_channel') !!} <span class="text-red">
                        *</span></label>
                <div class="col-sm-6">
                    {!! Form::select('target_channel', [''=> '-- '.Lang::get('lang.select_a_channel').' --', 'A-0' =>
                    'Any', 'A-1' => 'Web Forms', 'A-4' => 'API Calls', 'A-2' => 'Emails'], null,['class' =>
                    'form-control', 'id' => 'execution_order']) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#close" data-toggle="tab">{!! Lang::get('lang.workflow_action') !!} <span class="text-red">
                                *</span></a>
                    </li>
                                            ...
                                            <tr id="firstdata">
                                                ...
                                                <td class="col-md-3">
                                                    <select class="form-control" name="rule[0][b]" required>
                                                        ...
                                                        <option value="not_equal">{!! Lang::get('lang.not_equal_to')
                                                            !!}</option>
                                                        <option value="contains">{!! Lang::get('lang.contains') !!}</option>
                                                        <option value="dn_contain">{!!
                                            ...
                                            <td>
                                                <select class="form-control" onChange="selectdata(0)" id="selected0"
                                                    ...
                                                    <optgroup label="Ticket">
                                                        ...
                                                        <option value="department">{!! Lang::get('lang.set_department')
                                                            !!}</option>
                                                        ...
                                                        <option value="helptopic">{!! Lang::get('lang.set_help_topic')
                                                            !!}</option>
                                                        <option value="status">{!! Lang::get('lang.set_ticket_status')
                                                            !!}</option>
                                                    </optgroup>
                                                </select>
                                            </td>
