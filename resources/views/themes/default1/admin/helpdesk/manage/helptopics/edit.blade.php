...
@section('content')
<!-- open a form -->
{!! Form::model($topics,['url' => 'helptopics/'.$topics->id, 'method' => 'PATCH']) !!}
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        @endif
        <!-- status radio: required: Active|Disable -->
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('slaplan') ? 'has-error' : '' }}">
    ...
    <div class="box-footer">
        <div class="form-group">
            <input type="checkbox" name="sys_help_topic" @if($sys_help_topic->helptopic_id == $topics->id) checked
