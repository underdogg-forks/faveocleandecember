...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <a href="{{route('helptopics.create')}}" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span>
    ...
    <div class="box-body table-responsive">
        ...
        <table class="table table-bordered dataTable">
            ...
            <tr style="padding-bottom:-30px">
                ...
                <td><a href="{{route('helptopics.edit',$topic->id)}}">{!! $topic->topic !!}
                ...
                <!-- Department -->
                @if($topic->department_id != null)
                <?php
                $dept = App\Model\helpdesk\Agent\Department::where('id', '=', $topic->department_id)->first();
                $dept = $dept->name;
                ?>
                @elseif($topic->department_id == null)
                <?php $dept = ""; ?>
                @endif
                <td> {!! $dept !!} </td>
                <!-- Last Updated -->
                ...
                <!-- Deleting Fields -->
                <td>
                    {!! Form::open(['route'=>['helptopics.destroy', $topic->id],'method'=>'DELETE']) !!}
                    <a href="{{route('helptopics.edit',$topic->id)}}" class="btn btn-info btn-xs btn-flat"><i class="fa fa-trash"
