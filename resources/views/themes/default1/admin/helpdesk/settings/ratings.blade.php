...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <div class="box-tools pull-right">
                <a class="btn btn-box-tool" href="{{ route('rating.create') }}" title="{!! Lang::get('lang.create') !!}"><i
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        {!!
                                        link_to_route('ratings.delete',Lang::get('lang.delete'),[$rating->id],['id'=>'delete','class'=>'btn
                                        btn-danger btn-sm']) !!}
                                    </div>
                                </div>
                            </div>
