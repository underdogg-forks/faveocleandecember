...
<div class="box box-primary">
    ...
    <div class="box-footer">
        <input type="button" class="btn btn-sm btn-primary" disabled="disabled" data-toggle="modal" data-target="#loadingpopup"
            value="{!! Lang::get('lang.clean-data-btn') !!}" id="clean-btn"></input>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div id="head">
                    ...
                    <br />
                    <center>
                        <h3 style="color:#80DE02;">{!! Lang::get('lang.cleaning-database') !!}</h3>
                    </center>
                    <br />
                    <center>
                        <h4>{!! Lang::get('lang.cleaning-in-progress') !!}</h4>
                    </center>
                    <center>
                        <h4>{!! Lang::get('lang.do-not-refresh') !!}</h4>
                    </center>
                    <br />
                </div>
            </div>
