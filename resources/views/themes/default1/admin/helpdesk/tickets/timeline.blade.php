...
<body class="skin-blue">
    <div class="wrapper">
            ...
            <section class="content">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <button type="button" class="btn btn-default"><i class="fa fa-edit" style="color:green;">
                                </i> Edit</button>
                            <button type="button" class="btn btn-default"><i class="fa fa-print" style="color:blue;">
                                </i> Print</button>
                            <!-- </div> -->
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#"><i class="fa fa-check-circle-o " style="color:green;"> </i>
                                            Resolved</a></li>
                                </ul>
                            </div>
                            <div class="btn-group">
                    ...
                    <div class='col-xs-12'>
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#General" data-toggle="tab" style="color:green;"><i class="fa fa-reply-all">
                                        </i> Reply</a></li>
                                <li><a href="#Reply" data-toggle="tab" style="color:orange;"><i class="fa fa-mail-forward">
                                        </i> Forward</a></li>
                            </ul>
                                ...
                                <div class="tab-pane active" id="General">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-default"><i class="fa fa-check-square-o"
                                                style="color:green;"> </i> Update</button>
                                        <button type="button" class="btn btn-default"><i class="fa fa-hand-o-right"
                                                style="color:orange;"> </i> Assign</button>
                                        <button type="button" class="btn btn-default"><i class="fa fa-file-text" style="color:blue;">
                                            </i> Internal Notes</button>
                                        <button type="button" class="btn btn-default"><i class="fa fa-arrows-alt" style="color:red;">
                                            </i> Surrender</button>
                                    </div>
                                    <form>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="Reply">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-default"><i class="fa fa-mail-forward"
                                                style="color:green;"> </i> Send</button>
                                        <button type="button" class="btn btn-default"><i class="fa fa-th-large" style="color:teal;">
                                            </i> Option</button>
                                        <button type="button" class="btn btn-default"><i class="fa fa-file-text" style="color:blue;">
                                            </i> Internal Notes</button>
                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class='timeline-footer'>
                                                <a class="btn btn-primary btn-xs"> <i class="fa fa-file-o" style="color:#fff;">
                                                    </i> Read more</a>
                                                <button type="button" class="btn btn-success btn-xs"><i class="fa fa-edit"
                                                        style="color:#fff;"> </i> Edit</button>
                                                <a class="btn btn-danger btn-xs"><i class="fa fa-trash" style="color:#fff;">
                                                    </i> Delete</a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2015 <a href="http://www.ladybirdweb.com">Ladybird Web Solution</a>.</strong>
            All rights reserved.
        </footer>
    </div><!-- ./wrapper -->
