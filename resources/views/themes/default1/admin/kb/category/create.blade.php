...
<div class="box box-primary">
	<div class="box-header">
		<h4 class="box-title">Add Category</h4> {!! Form::submit('save',['class'=>'form-group btn btn-primary
		pull-right'])!!}
	</div>
	<div class="box-body">
		...
		<div class="row">
			...
			<div class="col-xs-3 form-group {{ $errors->has('parent') ? 'has-error' : '' }}">
				...
				{!!Form::select('parent',[''=>'Select a Group','Categorys'=>$category->pluck('name','name')],null,['class' =>
				'form-control select']) !!}
			...
			<div class="col-md-12 form-group {{ $errors->has('description') ? 'has-error' : '' }}">
				...
				{!! Form::textarea('description',null,['class' => 'form-control','id'=>'description','placeholder'=>'Enter the
				description']) !!}
