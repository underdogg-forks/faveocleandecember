            ...
            <div class="tab-pane active" id="tab_1">
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-3 form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                        ...
                        {!!Form::select('language',['en'=>'English','ch'=>'Chinese'] ,null,['class' => 'form-control
                        select']) !!}
                    </div>
                    --}}
                    <div class="col-md-12 form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                        ...
                        '128x10','id'=>'address','placeholder'=>'Enter the address']) !!}
                    </div>
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        {!!Form::select('timezone',$time->pluck('location','location') ,null,['class' => 'form-control
                        select']) !!}
                    </div>
                </div>
            </div><!-- /.tab-pane -->
            <div class="tab-pane" id="tab_2">
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        {!!Form::select('dateformat',$date->pluck('format','format') ,null,['class' => 'form-control
                        select']) !!}
                    </div>
                </div>
            </div><!-- /.tab-pane -->
