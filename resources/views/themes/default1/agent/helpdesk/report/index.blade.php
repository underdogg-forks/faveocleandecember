...
<div class="box box-info">
    ...
    <div class="box-footer">
        <div class="row">
            <div class="col-sm-3 col-xs-6">
                <div class="description-block border-right">
                    <h3><span class="description-percentage text-yellow"><i class="fa fa-file-text-o"> </i> <small
                                class="text-yellow"><i class="fa fa-random"> </i></small> <span id="total-inprogress-tickets">
                            </span> </span></h3>
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="description-block border-right">
                    <h3><span class="description-percentage text-blue"><i class="fa fa-file-text-o"> </i> + <span id="total-created-tickets">
                            </span> </span></h3>
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="description-block border-right">
                    <h3><span class="description-percentage text-yellow"><i class="fa fa-file-text-o"></i> <small class="text-yellow"><i
                                    class="fa fa-refresh"> </i></small> <span id="total-reopen-tickets"> </span> </span></h3>
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="description-block">
                    <h3><span class="description-percentage text-green"><i class="fa fa-file-text-o"> </i> <small class="text-green"><i
                                    class="fa fa-times"> </i></small> <span id="total-closed-tickets"> </span> </span></h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.getJSON("help-topic-report", function (result) {
            ...
            var myLineChart = new Chart(document.getElementById("tickets-graph").getContext("2d")).Line(
                buyerData, {
                    showScale: true,
        ...
        $('#foo').submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (result2) {
                    ...
                    var myLineChart1 = new Chart(document.getElementById("tickets-graph").getContext(
                        "2d")).Line(buyerData, {
                        showScale: true,
                        //Boolean - Whether grid lines are shown across the chart
                        scaleShowGridLines: true,
