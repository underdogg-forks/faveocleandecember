            ...
            if (c_status != 'hard-delete') {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#spin").hide();
                        var message =
                            "{!! Lang::get('lang.status-changed-successfully') !!} {!! Lang::get('lang.reload-be-patient-message') !!}";
                        $(".success-message, .success-msg, .get-success, #get-success").html(
                            message);
                        $(".alert-success").show();
                        setTimeout(function () {
                            location.reload();
        ...
        $('#assign-form').on('submit', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 1) {
                        var message =
                            "{!!Lang::get('lang.ticket-assigned-successfully')!!} {!!Lang::get('lang.reload-be-patient-message')!!}"
                        $(".success-message, .success-msg, .get-success, #get-success").html(
                            message);
                        $(".alert-success").show();
