...
<li>
    ...
    <a href="#">
        ...
        <small class="pull-right">
            ...
            <input type="radio" class="star not-apply" id="star5" name="{!! $rating->name !!}" value="{!! $i !!}" <?php
                echo ($ratingval==$i) ? 'checked' : '' ?> />
            <?php } ?>
        </small>
    </a>
    @else
...
<div class="box box-primary">
    <div class="box-header">
        ...
        <div class="pull-right">
            ...
            <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#{{$tickets->id}}assign"><i
                    class="fa fa-hand-o-right" style="color:orange;"> </i> {!! Lang::get('lang.assign') !!}</button>
            <?php } ?>

            @if($tickets->assigned_to == Auth::user()->id)
            <button type="button" id="surrender_button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#surrender">
                <i class="fa fa-arrows-alt" style="color:red;"> </i> {!! Lang::get('lang.surrender') !!}</button>
            @endif


            <?php Event::fire('show-add-event-btn', array()); ?>

            <a href="{{url('ticket/print/'.$tickets->id)}}" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print">
                </i> {!! Lang::get('lang.generate_pdf') !!}</a>
            <div class="btn-group">
            ...
            <div id="more-option" class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                    <li data-toggle="modal" data-target="#ChangeOwner"><a href="#"><i class="fa fa-users" style="color:green;">
                            </i>Change Owner</a></li>
                    @if($tickets->status != 3 && $tickets->status != 2)
                    <li data-toggle="modal" data-target="#MergeTickets"><a href="#"><i class="fa fa-code-fork" style="color:teal;">
                            </i>{!! Lang::get('lang.merge-ticket') !!}</a></li>
                    @endif
    ...
    <div class='col-xs-12'>
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#General" data-toggle="tab" style="color:#27C116;" id="aa"><i class="fa fa-reply-all">
                        </i> {!! Lang::get('lang.reply') !!}</a></li>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}" id="reply_content_class">
                                        <div class="col-md-2">
                                            {!! Form::label('Reply Content', Lang::get('lang.reply_content').':') !!}<span
                                                class="text-red"> *</span>
                                        </div>
                                        <div class="col-md-10">
                                            <div id="newtextarea">
                                    ...
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}" id="reply_content_class">
                                        ...
                                        <div class="col-md-10">
                                            <div id="reset-attachment">
                                                ...
                                                $max_size_in_actual !!}
                                                <div>
                                                    <a id='clear-file' onClick='clearAll()' style='display:none; cursor:pointer;'><i
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <div id="t5">
                                                <button id="replybtn" type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"
                                                        style="color:white;"> </i> {!! Lang::get('lang.update') !!}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="timeline-item">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="button:disabled;">
                                                        ...
                                                        <input type="radio" class="star star-rating-readonly not-apply"
                                                            id="star5" name="{!! $rating->name !!},{!! $conversation->id !!}"
                                ...
                                <h3 class="timeline-header">
                                    ...
                                    <div class="user-block" style="margin-bottom:-5px;margin-top:-2px;">
                                        ...
                                        <span class="description" style="margin-bottom:4px;margin-top:4px;"><i class="fa fa-clock-o"></i>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sla_paln">
                                    ...
                                    <option value="{!! $sla_plan->id !!}" <?php if ($SlaPlan->id == $sla_plan->id) {
                                        echo "selected";
                                        }
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="help_topic">
                                    ...
                                    <option value="{!! $helptopic->id !!}" <?php if ($help_topic->id == $helptopic->id)
                                        {
                                        echo 'selected';
                                        }
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ticket_source">
                                    ...
                                    <option value="{!! $ticketsource->id !!}" <?php if ($tickets->source ==
                                        $ticketsource->id) {
                                        echo "selected";
                                        }
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ticket_priority">
                                    ...
                                    <option value="{!! $ticket_priority->priority_id !!}" <?php if ($tickets->priority_id
    ...
    <div class="modal fade" id="ChangeOwner">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#ahah1" data-toggle="tab" style="color:green;" id="aa"><i class="fa fa-users">
                                </i> {!! Lang::get('lang.search_existing_users') !!}</a></li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="ahah1">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis42">{!!
                                    Lang::get('lang.close') !!}</button>
    ...
    <div class="modal fade" id="addccc">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#ahah" data-toggle="tab" style="color:green;" id="aa"><i class="fa fa-users">
                                </i> {!! Lang::get('lang.search_existing_users') !!}</a></li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="ahah">
                            <div class="modal-body" id="def">
                                <div class="callout callout-info" id="hide1234"><i class="icon fa fa-info"> </i>&nbsp;&nbsp;&nbsp;
                                    {!! Lang::get('lang.search_existing_users_or_add_new_users') !!}</div>
                                <div id="here"></div>
                ...
                {{-- <div class="modal-footer"> --}}
                    {{-- <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis9"
                        data-dismiss="alert">Close</button> --}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="surrender22">
                    ...
                    <div id="alert11" class="alert alert-dismissable" style="background-color:#F2F2F2">
                        ...
                        <button id="dismiss11" type="button" class="close" data-dismiss="alert" onclick="remove_collaborator({!! $ccc->id !!})"
                            aria-hidden="true">×</button>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="col-md-8">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{!! URL::route('ticket.thread',$tickets->id) !!}"><button type="button" class="btn btn-primary yes"
...
<script type="text/javascript">
        ...
        $('#resolved').on('click', function (e) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#show2").hide();
                    var message =
                        "{!! Lang::get('lang.your_ticket_have_been_resolved') !!}";
                    $("#alert11").show();
                    $('#message-success1').html(message);
                    setInterval(function () {
                        $("#alert11").hide();
        ...
        $('#delete').on('click', function (e) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#show2").hide();
                    var message =
                        "{!! Lang::get('lang.your_ticket_have_been_moved_to_trash') !!}";
                    $("#alert11").show();
                    $('#message-success1').html(message);
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response != 1) {
                        ...
                        if (response == 400) {
                            message =
                                "{{Lang::get('lang.selected-user-is-already-the-owner')}}";
                        }
                        $('#change_alert').show();
                        ...
                        $("#change-refresh").load(
                            "../thread/{{$tickets->id}}  #change-refresh");
        ...
        $('#form2').on('submit', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 1) {
                        $("#refresh1").load("../thread/{{$tickets->id}}   #refresh1");
                        $(".embed-responsive-item").load(
                            "../thread/{{$tickets->id}}   .embed-responsive-item");

                        // $("#t4").load("../thread/{{$tickets->id}}   #t4");
                        var message =
                            "{!! Lang::get('lang.internal-note-has-been-added') !!}";
                        $("#alert21").show();
                        ...
                        div.innerHTML = div.innerHTML +
                            '<textarea style="width:98%;height:200px;" name="reply_content" class="form-control" id="reply_content"/></textarea>';
                        $("#newtextarea1").empty();
                        var div1 = document.getElementById('newtextarea1');
                        div1.innerHTML = div1.innerHTML +
                            '<textarea style="width:98%;height:200px;" name="InternalContent" class="form-control" id="InternalContent"/></textarea>';
                        ...
                        setInterval(function () {
                            ...
                            script.type = 'text/javascript';
                            script.src =
                                '{{asset("lb-faveo/js/jquery.rating.pack.js")}}';
                        ...
                        // alert('fail');
                        var message =
                            "{!! Lang::get('lang.for_some_reason_your_message_was_not_posted_please_try_again_later') !!}";
                        $("#alert23").show();
                        $('#message-danger2').html(message);
                        setInterval(function () {
                            $("#alert23").hide();
            ...
            if (!input) {
                ...
                for (i = 0; i < input.files.length; i++) {
                    ...
                    if (file.size < supported_size) {
                        $("#file_details").append("<tr> <td> " + file.name + " </td><td> " +
                            formatBytes(file.size) + "</td> </tr>");
                    } else {
                        $("#file_details").append("<tr style='color:red;'> <td> " + file.name +
                            " </td><td> " + formatBytes(file.size) + "</td> </tr>");
                    }
                    total_size += parseInt(file.size);
                }
                if (total_size > supported_size) {
                    $("#total-size").append(
                        "<span style='color:red'>Your total file upload size is greater than " +
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 1) {
                        ...
                        var message =
                            "{!! Lang::get('lang.you_have_unassigned_your_ticket') !!}";
                        $("#alert11").show();
                        $('#message-success1').html(message);
                        setInterval(function () {
                            $("#dismiss11").trigger("click");
                        ...
                        var message =
                            "{!! Lang::get('lang.for_some_reason_your_request_failed') !!}";
                        $("#alert13").show();
    ...
    $(document).ready(function () {
        ...
        function parentAjaxCall() {
            ...
            if (arr == null) {
                document.getElementById("select-merge-parent").innerHTML =
                    "<option value='{{$tickets->id}}'><?php
                $ticket_data = App\ Model\ helpdesk\ Ticket\ Ticket_Thread::select('title') - > where(
                    'ticket_id', "=", $tickets - > id) - > first();
                echo $ticket_data - > title; ?
                > < /option>"
            } else {
                $.ajax({
                        ...
                        switch (e.type) {
                            case "blur":
                                ...
                                setTimeout(function () {
                                    ...
                                    $("#custom-alert-body").html(
                                        "{!! Lang::get('lang.ticket-lock-inactive') !!}");
