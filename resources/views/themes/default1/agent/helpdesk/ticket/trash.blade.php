...
<div class="box box-warning">
    <div class="box-header with-border">
        <h3 class="box-title">{!! Lang::get('lang.trash') !!} </h3> <small id="title_refresh">{!! $tickets !!} {!!
    ...
    <div class="box-body">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><input type="submit" class="btn btn-block btn-default btn-sm text-green" id="delete" name="submit"
                        value="{!! Lang::get('lang.open') !!}">
                </li>
                <li><input type="submit" class="btn btn-block btn-default btn-sm text-yellow" name="submit" id="close"
                        value="{!! Lang::get('lang.close') !!}"></li>

            </ul>
        </div>
        <input type="submit" class="btn btn-default text-yellow btn-sm" name="submit" id="hard-delete" value="{{Lang::get('lang.clean-up')}}"
            title="{{Lang::get('lang.trash-delete-title-msg')}}">
