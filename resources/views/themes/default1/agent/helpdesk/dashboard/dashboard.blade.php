...
<!-- my beautiful agent layout dashboard found in resources\views/themes/default1/agent/helpdesk/dashboard/dashboard.blade.php -->
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        <?php echo $tickets->count() ?> <small> {!! Lang::get('lang.tickets') !!}</small></span>
