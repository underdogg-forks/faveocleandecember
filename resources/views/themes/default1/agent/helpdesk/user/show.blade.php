...
<div class="row">
        ...
        <div class="box box-primary">
            ...
            <div class="box-footer">
                <div id="refresh-org">
                    ...
                    <a href="" class="pull-right" data-toggle="modal" data-target="#assign"><i class="fa fa-hand-o-right"
                            style="color:orange;"> </i> {!! Lang::get('lang.assign') !!} </a>
                    <a href="" data-toggle="modal" data-target="#create_org" class="pull-right">
                        {{Lang::get('lang.create')}} |&nbsp;</a>
                    @endif
                    @if($user_org != null)
                    <?php
                    ...
                    <a class="pull-right" href="#" data-toggle="modal" data-target="#{{$org_id}}delete" title="{!! Lang::get('lang.remove') !!}"><i
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {!! link_to_route('removeuser.org','Remove
                                    User',[$org_id],['id'=>'delete','class'=>'btn btn-danger btn-sm']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
 ...
 -->
                            ...
                            @if($user->role == 'agent')
                            {!! Form::label('delete_all_content',Lang::get('lang.delete_all_content')) !!} <span class="text-red">
                                *</span>
                            <?php
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {!!Form::select('group',[Lang::get('lang.groups')=>$groups->pluck('name','id')->toArray()],null,['class'
                        => 'form-control select']) !!}
                        <!-- </div> -->
                        <!-- primary dept -->
                        <!-- <div class="col-xs-4 form-group {{ $errors->has('primary_department') ? 'has-error' : '' }}"> -->
                        {!! Form::label('primary_dpt',Lang::get('lang.primary_department')) !!} <span class="text-red">
                            *</span>
                        {!! Form::select('primary_department',
                        [Lang::get('lang.departments')=>$departments->pluck('name','id')->toArray()],null,['class' =>
                        'form-control select']) !!}
                        <!-- </div> -->
                ...
                <div class="modal-body">
                    ...
                    <form name="myForm" action="{!!URL::route('user.post.changepassword', $users->id)!!}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::label('New password',Lang::get('lang.new_password')) !!} <span class="text-red">
                                *</span>
                    ...
                    <div class="box box-primary">
                        ...
                        <div style="margin-left:1%;">
                            ...
                            <div class="btn-group">
                                <button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-sm"
                                    data-toggle="modal" data-target="#addNewCategoryModal1">{{Lang::get('lang.change_role_to_agent')}}</button>
                            </div>
                            <div class="btn-group">
                                <button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-sm"
                                    data-toggle="modal" data-target="#addNewCategoryModal4">{{Lang::get('lang.change_role_to_admin')}}</button>
                            </div>
                            @else
                            <div class="btn-group">
                                <button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-sm"
                                    data-toggle="modal" data-target="#addNewCategoryModal2">{{Lang::get('lang.change_role_to_user')}}</button>
                            ...
                            @endif
                            @if(Auth::user()->role == 'admin')
                            <a href="{{route('user.edit', $users->id)}}"><button type="button" href="{{route('user.edit', $users->id)}}"
                                    class="btn btn-primary btn-sm">{{Lang::get('lang.edit')}}</button></a>
                            <button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-sm"
                                data-toggle="modal" data-target="#addNewCategoryModal">{{Lang::get('lang.change_password')}}</button>
                            <button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-sm"
                                data-toggle="modal" data-target="#addNewCategoryModal3">{{Lang::get('lang.delete')}}</button>
                            ...
                            <div id="page" class="hfeed site">
                                <article class="hentry error404 text-center">
                                    ...
                                    <h2 class="entry-title text-muted">{!! Lang::get('lang.user-account-is-deleted')
                                        !!}</h2>
                                    <div class="entry-content clearfix">
                                        <p class="lead">{!! Lang::get('lang.delete-account-caution-info') !!}</p>
                                        <p><button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-xs"
                                                data-toggle="modal" data-target="#addNewCategoryModal8">{{Lang::get('lang.restore-user')}}</button></a></p>
                                    </div><!-- .entry-content -->
                                </article><!-- .hentry -->
                            </div><!-- #page -->
                            <div class="row">
                            ...
                            <button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-sm"
                                data-toggle="modal" data-target="#addNewCategoryModal8">{{Lang::get('lang.restore')}}</button>
                            @elseif($users->role == 'agent')
                            This is a deleted contact
                            @endif
                            @endif
                        ...
                        <div style="padding:1%;">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="#tab_1" id="open_tab" data-toggle="tab">{!!
                                        Lang::get('lang.open_tickets') !!} ({{$open}})</a></li>
                                <li><a href="#tab_2" id="closed_tab" data-toggle="tab">{!!
                                        Lang::get('lang.closed_tickets') !!} ({{$counted}})</a></li>
                                <li><a href="#tab_3" id="deleted_tab" data-toggle="tab">{!!
                                        Lang::get('lang.deleted_tickets') !!} ({{$deleted}})</a></li>
                            </ul>
                                    ...
                                    <div id="more-option" class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li data-toggle="modal" data-target="#ChangeOwner"><a href="#" class="toggle-vis"
                                                    data-column="7"><i class="fa fa-plus-square-o" style="color:green;">
                                                    </i>{!!Lang::get('lang.created-at')!!}</a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    ?>
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4"><span id="legend-holder" style="background-color: #6C96DF;"></span>&nbsp;
                                                    <span class="lead"> <span id="total-created-tickets"></span> {!!
                                                        Lang::get('lang.assign_tickets') !!} </span></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger alert-dismissable" id="alert-danger" style="display:none;">
                            <i class="fa fa-ban"> </i> <b> {!! Lang::get('lang.alert') !!} ! <span id="get-danger"></span>
                            </b>
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        </div>
                        <div class="row" id="hide">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <spam id="error-name" style="display:none;position:fixed" class="call-out text-red">This
                                        is a required field</spam>
                                    <spam id="error-name1" style="display:none;position:fixed" class="call-out text-red">!
                                        Allready Taken</spam>
                                    <br />
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis4">{!!
                            Lang::get('lang.close') !!}</button>
                        <button type="submit" class="btn btn-success pull-right" id="submt2">{!!
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis4">{!!
                            Lang::get('lang.close') !!}</button>
                        <button type="submit" class="btn btn-success pull-right" id="submt3">{!!
                            Lang::get('lang.assign') !!}</button>
                    </div>
                    {!! Form::close()!!}
                </div><!-- /.modal-content -->
            ...
            $(document).ready(function () {
                ...
                $('#foo').submit(function (event) {
                    ...
                    $.ajax({
                        ...
                        url: '../user-chart-range/<?php echo $users->id; ?>/' + dateData + '/' +
                        ...
                        success: function (result2) {
                            ...
                            $(".chart").html(
                                "<canvas id='tickets-graph' width='1000' height='250'></canvas>"
                            );
