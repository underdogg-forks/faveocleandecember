...
<div class="box box-primary">
    ...
    <div class="box-header">
        <h3 class="box-title">{{Lang::get('lang.sidewidget2')}}</h3> {!!
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                    ...
                    {!! Form::textarea('content',null,['class' => 'form-control','size' =>
                    '128x10','id'=>'footer','placeholder'=>Lang::get('lang.enter_the_description')]) !!}
                </div>
