    ...
    $('#form').on('submit', function () {
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#wait').append('<ul><li>' + message + '</li><li class="seco">' + next +
                    '...</li></ul>');
                callApi(api);
            },
            error: function (response) {
                ...
                $('#retry').append(
                    '<input type="button" id="submitm" class="button-primary button button-large button-next" value="Retry" onclick="reload()">'
                );
...
<div style="border-bottom: 1px solid #eee;">
    @if(Cache::has('step4'))
    <?php Cache::forget('step4') ?> @endif
    <p class="setup-actions step">
        <input type="button" id="submitme" class="button-danger button button-large button-next" style="background-color: #d43f3a;color:#fff;"
...
<div id="legend">
    {{-- <ul> --}}
        <p class="setup-actions step">
            ...
            <span class="warning">Warning</span> &mdash; Not a deal breaker, but it's recommended to have this
            installed for some features to work<br />
