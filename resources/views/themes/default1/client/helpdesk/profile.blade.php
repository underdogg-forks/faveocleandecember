...
<div id="content" class="site-content col-md-12">
    ...
    <div class="row">
        <div class="col-md-6">
            {!! Form::model($user,['url'=>'client-profile-edit', 'id' => 'client-profile', 'method' =>
            'PATCH','files'=>true]) !!}
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-xs-2 form-group {{ $errors->has('country_code') ? 'has-error' : '' }}">
                            ...
                            {!! Form::text('country_code',null,['class' => 'form-control', 'placeholder' => $phonecode,
                            'title' => Lang::get('lang.enter-country-phone-code'), 'id' => 'code']) !!}
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('confirm_password') ? 'has-error' : '' }}">
                        {!! Form::label('confirm_password',Lang::get('lang.confirm_password')) !!}<span class="text-red">
                            *</span>
...
<div class="modal fade in" id="last-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"
            ...
            if (mobile !== old_mobile) {
                ...
                $.ajax({
                    ...
                    complete: function (jqXHR, textStatus) {
                        if (textStatus === "parsererror" || textStatus === "timeout" || textStatus ===
                            "abort" || textStatus === "error") {
