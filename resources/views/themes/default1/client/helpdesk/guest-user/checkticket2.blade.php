...
<div class="box box-primary">
    <div class="box-header">
        ...
        <section class="content-header">
            <h3 class="box-title"><i class="fa fa-user"> </i> {{$thread->title}} </h3> ( {{$tickets->ticket_number}} )
        </section>
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="General">
                                ...
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"
                                                style="color:blue;"> </i> Update</button> </div>
                                </div>
                            </div>
                        </div>
                        {!!Form::close()!!}
                    ...
                    <div id="t2" style="display:none">
                        ...
                        <div class="form-group">
                            ...
                            <button style="display:none;" type="submit" id="tt2" class="btn btn-default"><i class="fa fa-check-square-o"
                                    style="color:blue;"> </i> Update</button>
                            <button type="button" class="btn btn-default"><i class="fa fa-hand-o-right" style="color:orange;">
                                </i> {!! link_to_route('assign.ticket','Assign') !!}</button>
                            <button type="button" id="internal" class="btn btn-default"><i class="fa fa-file-text"
                                    style="color:blue;"> </i> Internal Notes</button>
                ...
                <div class="tab-pane" id="Reply">
                    <div class="form-group">
                        <button type="button" class="btn btn-default"><i class="fa fa-mail-forward" style="color:green;">
                            </i> Send</button>
                ...
                <ul class="timeline">
                    ...
                    <li>
                        ...
                        <div class="timeline-item">
                            <span id="date" class="time"><i class="fa fa-clock-o"> </i>
        ...
        $('#close').on('click', function (e) {
            $.ajax({
                ...
                success: function (response) {
                    $("#refresh").load(
                        "http://localhost/faveo/public/thread/{{$tickets->id}}   #refresh"
                    );
                }
            })
            return false;
