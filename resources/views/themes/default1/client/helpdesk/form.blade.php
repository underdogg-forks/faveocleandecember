...
<div id="content" class="site-content col-md-9">
    ...
    <div>
        ...
        <div class="row col-md-12">
            ...
            <div class="col-md-12 form-group">{!! Form::submit(Lang::get('lang.Send'),['class'=>'form-group btn
                btn-info pull-left', 'onclick' => 'this.disabled=true;this.value="Sending, please
