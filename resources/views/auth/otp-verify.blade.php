...
<div class="form-group has-feedback {{ $errors->has('otp') ? 'has-error' : '' }}">
    {!! Form::input('text','otp',null,['placeholder'=> Lang::get("lang.enter-otp") ,'class' => 'form-control' ,
    'required' => true, 'pattern' => "[0-9]{6}", "title" => Lang::get('lang.otp-input-title')]) !!}
    <!-- {!! $errors->first('email', '<spam class="help-block">:message</spam>') !!} -->
</div>
...
<div class="row">
    <div class="col-xs-8">
        ...
        <a id="resend" onclick="resendOTP();" href="#" title="{!!Lang::get('lang.resend-otp-title') !!}">{!!
            Lang::get("lang.resend_otp") !!}</a><br>
    </div><!-- /.col -->
    <div class="col-xs-4">
    ...
    function resendOTP() {
        ...
        $.ajax({
            ...
            complete: function (jqXHR, textStatus) {
                if (textStatus === "parsererror" || textStatus === "timeout" || textStatus === "abort" ||
                    textStatus === "error") {
