...
class AddForeignKeysToUserAssignOrganizationTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('crm__user_assign_organization', function (Blueprint $table) {
            $table->foreign('org_id', 'user_assign_organization_ibfk_1')->references('id')->on('crm__relations')->onUpdate('NO ACTION')->onDelete('RESTRICT');
